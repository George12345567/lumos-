...
export const ROLE_PERMISSIONS: Record<AdminRole, RoleMatrix> = {
  ...
  manager: {
    ...
    clients: VIEW_EDIT,
    projects: { view: true, edit: true, assign: true, upload: true, download: true },
    contacts: VIEW_CREATE_EDIT,
    messages: VIEW_CREATE_EDIT,
    files: { view: true, upload: true, download: true },
    identity: VIEW_EDIT,
    team: VIEW_ONLY,
    discounts: VIEW_ONLY,
    audit_logs: VIEW_ONLY,
  ...
  designer: {
    ...
    overview: VIEW_ONLY,
    clients: VIEW_ONLY,
    projects: { view: true, edit: true, upload: true, download: true },
    files: { view: true, create: true, edit: true, upload: true, download: true },
    identity: { view: true, create: true, edit: true, upload: true, download: true },
    messages: VIEW_CREATE_EDIT,
  },
  support: {
    dashboard: VIEW_ONLY,
